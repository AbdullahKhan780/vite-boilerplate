...
export function Privacy() {
  return (
    <>
      <Metadata title={"Darb Assabil - Privacy Policy"} />

      <section className="px-3">
        <div className="max-w-6xl w-full mx-auto py-10 flex flex-col gap-3">
          <h1 className="text-6xl font-medium">Privacy Policy</h1>
          <p>
            Sabil built the Sabil app as a Free app. This SERVICE is provided by
            Sabil at no cost and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Sabil unless
          ...
          <p>
            ...
            including but not limited to Photos . The information that we
          ...
          <h3 className="text-3xl font-medium">Log Data</h3>
          <p>
          ...
          <h3 className="text-3xl font-medium">Cookies</h3>
          <p>
          ...
          <h3 className="text-3xl font-medium">Service Providers</h3>
          <p>
          ...
          <h3 className="text-3xl font-medium">Security</h3>
          <p>
          ...
          <h3 className="text-3xl font-medium">Links to Other Sites</h3>
          <p>
          ...
          <h3 className="text-3xl font-medium">Children's Privacy</h3>
          <p>
