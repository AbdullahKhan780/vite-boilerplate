...
export function TermsOfServices() {
  return (
    <>
      <Metadata title={"Darb Assabil - Terms Of Services"} />

      <section className="px-3">
        <div className="max-w-6xl w-full mx-auto py-10 flex flex-col gap-3">
          <h1 className="text-6xl font-medium">Terms &amp; Conditions</h1>
          <p>
            ...
            property rights related to it, still belong to Sabil.
          </p>
          <p>
            Sabil is committed to ensuring that the app is as useful and
          ...
          <p>
            The Sabil app stores and processes personal data that you have
            ...
            mean that the Sabil app won't work properly or at all.
          </p>
          <div>
            <p>
          ...
          <p>
            You should be aware that there are certain things that Sabil will
            ...
            provider, but Sabil cannot take responsibility for the app not
          ...
          <p>
            Along the same lines, Sabil cannot always take responsibility for
            ...
            to avail the Service, Sabil cannot accept responsibility.
          </p>
          <p>
            With respect to Sabil's responsibility for your use of the app, when
            ...
            can make it available to you. Sabil accepts no liability for any
          ...
          <p>
            ...
            to keep using the app. Sabil does not promise that it will always
            ...
            you, We may also wish to stop providing the app, and may terminate
          ...
          <p>
            ...
            <a href="mailto:support@sabil.ly">here</a>.
          </p>
        </div>
      </section>
    </>
